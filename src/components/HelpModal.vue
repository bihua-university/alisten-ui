      ...
      <div class="flex-none px-6 py-6 md:px-12 md:py-8 flex justify-between items-start md:items-center max-w-7xl w-full mx-auto">
        <div>
          <h1 class="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400 flex items-center gap-3">
            <i class="fa-solid fa-book-open text-purple-400" />
            使用指南
          </h1>
        ...
        <div class="max-w-7xl mx-auto px-6 pb-12 md:px-12">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors duration-300">
              ...
              <ul class="space-y-4">
                <li class="flex items-start gap-3">
                  <i class="fa-solid fa-search text-purple-400 mt-1" />
                  <div>
                ...
                <li class="flex items-start gap-3">
                  <i class="fa-solid fa-sync text-indigo-400 mt-1" />
                  <div>
            ...
            <div class="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors duration-300">
              ...
              <ul class="space-y-4">
                <li class="flex items-start gap-3">
                  <i class="fa-solid fa-forward text-blue-400 mt-1" />
                  <div>
                ...
                <li class="flex items-start gap-3">
                  <i class="fa-solid fa-list text-sky-400 mt-1" />
                  <div>
            ...
            <div class="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors duration-300">
              ...
              <ul class="space-y-4">
                <li class="flex items-start gap-3">
                  <i class="fa-solid fa-paper-plane text-green-400 mt-1" />
                  <div>
                ...
                <li class="flex items-start gap-3">
                  <i class="fa-solid fa-heart text-red-400 mt-1" />
                  <div>
                ...
                <li class="flex items-start gap-3">
                  <i class="fa-solid fa-user-plus text-emerald-400 mt-1" />
                  <div>
            ...
            <div class="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors duration-300">
              ...
              <ul class="space-y-4">
                <li class="flex items-start gap-3">
                  <i class="fa-solid fa-id-card text-pink-400 mt-1" />
                  <div>
                ...
                <li class="flex items-start gap-3">
                  <i class="fa-solid fa-volume-high text-rose-400 mt-1" />
                  <div>
            ...
            <div class="bg-yellow-500/5 border border-yellow-500/20 rounded-2xl p-6 hover:bg-yellow-500/10 transition-colors duration-300 md:col-span-2 lg:col-span-1">
              ...
              <ul class="space-y-3">
                <li class="flex items-start gap-3 text-sm text-gray-300">
                  <span class="w-1.5 h-1.5 rounded-full bg-yellow-500 mt-2 flex-shrink-0" />
                  请保持友善交流，共同维护良好的社区氛围。
                </li>
                <li class="flex items-start gap-3 text-sm text-gray-300">
                  <span class="w-1.5 h-1.5 rounded-full bg-yellow-500 mt-2 flex-shrink-0" />
